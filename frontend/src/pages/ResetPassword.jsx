...
const ResetPassword = () => {
  ...
  const[isOtpSubmited, setOtpSubmited] = useState(false)
    ...
    /* this is code for passing input field to another field automatically  */
    ...
    /* this is code for passing input focus to back one step automatically  */
    ...
    const handleKeyDown = (e, index) => {
      ...
      /* this is code for when User Paste the OTP then automatically 6 digit OTP fill in 6 input box */
  ...
  return (
    ...
    <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
     ...
     <button className=' cursor-pointer w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full mt-3'>Submit</button>
    </form>
  }
